    ...
    def on_event(
        ...
        if dora_event["type"] == "INPUT":
            ...
            if self.context_rag is not None and self.task is not None:
                ...
                send_output("reasoner_response", pa.array([create_agent_output(agent_name='reasoner_response', agent_result=agent_result, dataflow_status=os.getenv('IS_DATAFLOW_END', True))]), dora_event['metadata'])
