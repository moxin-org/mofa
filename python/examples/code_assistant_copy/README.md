...
| **File**                       | **Purpose**                                                                  |
| ------------------------------ | ---------------------------------------------------------------------------- |
| `code_assistant_copy_agent.yml` | Provides new code based on the user's question or code snippet.|
...
3. **Execute the Following Command to Start the Agent Process**
    ...
    ```bash
    dora up && dora build code_assistant_copy_dataflow.yml && dora start code_assistant_copy_dataflow.yml --attach
    ```
...
### Attention
As a demo, the content of the code must be in the code_assistant_copy folder and be named as *.py.
