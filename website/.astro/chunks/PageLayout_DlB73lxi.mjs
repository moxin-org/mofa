...
import { g as getCollection } from './_astro_content_Bc5p-jd3.mjs';
...
async function getNavigationContent() {
  ...
  const homeContent = allSiteContent.find(
    (entry) => entry.id.startsWith(`${currentLang}/home`) || // 如果找不到当前语言的内容，使用英文作为后备
    currentLang !== "en" && entry.id.startsWith("en/home")
  );
  return homeContent?.data || {};
}
async function createHeaderData() {
  const content = await getNavigationContent();
  const nav = content.nav || {};
  return {
    links: [
      {
        text: nav.home || t("nav.home"),
        href: getPermalink("/")
      },
      {
        text: nav.docs || t("nav.docs"),
        links: [
          {
            text: nav.quickStart || t("nav.quickStart"),
            href: getPermalink("/docs/getting-started")
          },
          {
            text: nav.coreConcepts || t("nav.coreConcepts"),
            href: getPermalink("/docs/core-concepts")
          },
          {
            text: nav.tutorials || t("nav.tutorials"),
            href: getPermalink("/docs/tutorials")
          },
          {
            text: nav.api || t("nav.api"),
            href: getPermalink("/docs/api")
          },
          {
            text: nav.installation || t("nav.installation"),
            href: getPermalink("/docs/installation")
          }
        ]
      },
      {
        text: nav.examples || t("nav.examples"),
        links: [
          {
            text: nav.helloWorld || t("nav.helloWorld"),
            href: getPermalink("/examples/hello-world")
          },
          {
            text: nav.rag || t("nav.rag"),
            href: getPermalink("/examples/rag")
          },
          {
            text: nav.arxiv || t("nav.arxiv"),
            href: getPermalink("/examples/arxiv")
          },
          {
            text: nav.reflection || t("nav.reflection"),
            href: getPermalink("/examples/reflection")
          },
          {
            text: nav.multiAgent || t("nav.multiAgent"),
            href: getPermalink("/examples/multi-agent")
          }
        ]
      },
      {
        text: nav.community || t("nav.community"),
        links: [
          {
            text: nav.discord || t("nav.discord"),
            href: "https://discord.gg/mofa",
            target: "_blank"
          },
          {
            text: nav.wechat || t("nav.wechat"),
            href: getPermalink("/community/wechat")
          },
          {
            text: nav.contributing || t("nav.contributing"),
            href: getPermalink("/community/contributing")
          },
          {
            text: nav.contributors || t("nav.contributors"),
            href: getPermalink("/community/contributors")
          },
          {
            text: nav.blog || t("nav.blog"),
            href: getBlogPermalink()
          }
        ]
      },
      {
        text: nav.about || t("nav.about"),
        href: getPermalink("/about")
      }
    ],
    actions: [{ text: nav.github || t("nav.github"), href: "https://github.com/moxin-org/mofa", target: "_blank" }]
  };
}
async function createFooterData() {
  ...
  return {
    links: [
      {
        title: footer.docs || t("footer.docs"),
        links: [
          { text: nav.quickStart || t("nav.quickStart"), href: getPermalink("/docs/getting-started") },
          { text: nav.coreConcepts || t("nav.coreConcepts"), href: getPermalink("/docs/core-concepts") },
          { text: nav.tutorials || t("nav.tutorials"), href: getPermalink("/docs/tutorials") },
          { text: nav.api || t("nav.api"), href: getPermalink("/docs/api") },
          { text: nav.installation || t("nav.installation"), href: getPermalink("/docs/installation") }
        ]
      },
      {
        title: footer.examples || t("footer.examples"),
        links: [
          { text: nav.helloWorld || t("nav.helloWorld"), href: getPermalink("/examples/hello-world") },
          { text: nav.rag || t("nav.rag"), href: getPermalink("/examples/rag") },
          { text: nav.arxiv || t("nav.arxiv"), href: getPermalink("/examples/arxiv") },
          { text: nav.reflection || t("nav.reflection"), href: getPermalink("/examples/reflection") },
          { text: nav.multiAgent || t("nav.multiAgent"), href: getPermalink("/examples/multi-agent") }
        ]
      },
      {
        title: footer.community || t("footer.community"),
        links: [
          { text: nav.discord || t("nav.discord"), href: "https://discord.gg/mofa", target: "_blank" },
          { text: nav.wechat || t("nav.wechat"), href: getPermalink("/community/wechat") },
          { text: nav.contributing || t("nav.contributing"), href: getPermalink("/community/contributing") },
          { text: nav.contributors || t("nav.contributors"), href: getPermalink("/community/contributors") },
          { text: nav.blog || t("nav.blog"), href: getBlogPermalink() }
        ]
      },
      {
        title: footer.about || t("footer.about"),
        links: [
          { text: footer.origins || t("footer.origins"), href: getPermalink("/about") },
          { text: footer.team || t("footer.team"), href: getPermalink("/about#team") },
          { text: footer.moxin || t("footer.moxin"), href: "https://moxin.ai", target: "_blank" },
          { text: footer.contact || t("footer.contact"), href: getPermalink("/contact") }
        ]
      }
    ],
    secondaryLinks: [
      { text: footer.terms || t("footer.terms"), href: getPermalink("/terms") },
      { text: footer.privacy || t("footer.privacy"), href: getPermalink("/privacy") }
    ],
    socialLinks: [
    ...
    footNote: `
      <div class="flex items-center">
        ...
        <span>© ${(/* @__PURE__ */ new Date()).getFullYear()} MoFA.AI · ${footer.rights || t("footer.rights")}</span>
      </div>
    `
  };
}
