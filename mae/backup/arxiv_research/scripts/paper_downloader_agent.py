    ...
    def on_event(
        ...
        if dora_event["type"] == "INPUT":
            ...
            if dora_event['id'] in agent_inputs:
                ...
                print('-------  : ',agent_result)
                send_output("papers_info", pa.array([create_agent_output(step_name='papers_info', output_data=agent_result,dataflow_status=os.getenv('IS_DATAFLOW_END',False))]),dora_event['metadata'])
