import os
import dspy
from mae.agent_build.crewai.manage import create_agent, create_task, setup_crew
from mae.agent_build.reasoner.reasoner import ReasonerModule, ReasonerRagModule, ReasonerWebSearchModule
from mae.agent_build.self_refine.self_refine import SelfRefineModule, SelfRefineRagModule
...
def run_dspy_agent(agent_config: dict):
    ...
    if agent_config.get('model_api_key') != 'ollama':
